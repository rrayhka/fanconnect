...
$newsTotal = count(getAllNews());
$news= getAllNewsWithUploaderWithLimit($newsPerPage,($nowPage * $newsPerPage)-$newsPerPage);
// var_dump($news);
...
<section class="news-list">
    ...
    <div class="card-base-info">
        ...
        <div class="page-link">
            <?php for($x=1;$x <= ceil($newsTotal/$newsPerPage);$x++) : ?>
                <?php if($x == $nowPage) : ?>
                    <a class="page-item font-kanit active" href="?page=<?php echo $x ?>"><?php echo $x; ?></a>
                <?php else : ?>
                    <a class="page-item font-kanit" href="?page=<?php echo $x ?>"><?php echo $x; ?></a>
                <?php endif; ?>
            <?php endfor; ?>
        </div>
